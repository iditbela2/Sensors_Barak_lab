...
import sensorPMS5003  # importing is done here because class is creating a file in logs_debug folder which is only created in setFolder

# create log debug file
logging.basicConfig(
    filename='/home/pi/logs_debug/sensor_{0}_debug_{1}.log'.format(str(SELECTED_HARDWARE), datetime.datetime.now()),
    level=logging.DEBUG,
